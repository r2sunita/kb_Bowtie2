...
/**
 * <p>Original spec-file module name: kb_Bowtie2</p>
 * <pre>
 * A KBase module: kb_Bowtie2
 * </pre>
 */
public class KbBowtie2Client {
     ...
     */
    public KbBowtie2Client(URL url) {
     ...
     * validity.
     */
    public KbBowtie2Client(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public KbBowtie2Client(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public KbBowtie2Client(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
    ...
    /**
     * <p>Original spec-file function name: run_bowtie2_cli</p>
     * <pre>
     * general purpose local function for running tools in the bowtie2 suite
     * </pre>
     * @param   params   instance of type {@link us.kbase.kbbowtie2.RunBowtie2CLIParams RunBowtie2CLIParams}
     * @throws IOException if an IO exception occurs
     * @throws JsonClientException if a JSON RPC exception occurs
     */
    public void runBowtie2Cli(RunBowtie2CLIParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        List<Object> args = new ArrayList<Object>();
        args.add(params);
        TypeReference<Object> retType = new TypeReference<Object>() {};
        caller.jsonrpcCall("kb_Bowtie2.run_bowtie2_cli", args, retType, false, true, jsonRpcContext, this.serviceVersion);
    }

    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        List<Object> args = new ArrayList<Object>();
        TypeReference<List<Map<String, Object>>> retType = new TypeReference<List<Map<String, Object>>>() {};
        List<Map<String, Object>> res = caller.jsonrpcCall("kb_Bowtie2.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
