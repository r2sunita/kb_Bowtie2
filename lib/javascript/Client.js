...
function kb_Bowtie2(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.align_reads_to_assembly_app = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_Bowtie2.align_reads_to_assembly_app",
            [params], 1, _callback, _errorCallback);
    };
 
     this.align_one_reads_to_assembly = function (_callback, _errorCallback) {
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        if (_errorCallback && typeof _errorCallback !== 'function')
            throw 'Argument _errorCallback must be a function if defined';
        ...
        return json_call_ajax(_url, "kb_Bowtie2.align_one_reads_to_assembly",
            [], 0, _callback, _errorCallback);
    };
 
     this.get_bowtie2_index = function (params, _callback, _errorCallback) {
        if (typeof params === 'function')
            throw 'Argument params can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "kb_Bowtie2.get_bowtie2_index",
            [params], 1, _callback, _errorCallback);
    };
 
     this.run_bowtie2_cli = function (params, _callback, _errorCallback) {
        if (typeof params === 'function')
            throw 'Argument params can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "kb_Bowtie2.run_bowtie2_cli",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_Bowtie2.status",
